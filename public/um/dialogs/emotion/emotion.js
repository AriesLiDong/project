(function(){
    ...
    UM.registerWidget('emotion',{
        ...
        sourceData: {
            emotion: {
                tabNum:7, //切换面板数量
                SmilmgName:{  'edui-emotion-Jtab3':['B_00', 63], 'edui-emotion-Jtab4':['C_00', 20], 'edui-emotion-Jtab5':['i_f', 50], 'edui-emotion-Jtab6':['y_00', 40] }, //图片前缀名
                imageFolders:{ 'edui-emotion-Jtab3':'bobo/', 'edui-emotion-Jtab4':'babycat/', 'edui-emotion-Jtab5':'face/', 'edui-emotion-Jtab6':'youa/'}, //图片对应文件夹路径
                imageCss:{'edui-emotion-Jtab3':'bb', 'edui-emotion-Jtab4':'cat', 'edui-emotion-Jtab5':'pp', 'edui-emotion-Jtab6':'youa'}, //图片css类名
                imageCssOffset:{'edui-emotion-Jtab3':35, 'edui-emotion-Jtab4':35, 'edui-emotion-Jtab5':25, 'edui-emotion-Jtab6':35}, //图片偏移
                SmileyInfor:{
        ...
        initContent:function( _editor, $widget ){
            ...
            emotion.SmileyPath = _editor.options.emotionLocalization === true ? emotionUrl + 'images/' : "http://www.blog.com/home/emotion/";
        ...
        createTab: function( contentBoxId ) {
            ...
            for ( ; i < imgNum; ) {
                ...
                for ( var j = 0; j < imgColNum; j++, i++ ) {
                    ...
                    if ( faceImage ) {
                        sUrl = 'http://www.blog.com/home/emotion/bobo/'+faceImage;
