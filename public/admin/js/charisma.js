$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', 'http://www.blog.com/admin/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', 'http://www.blog.com/admin/css/bootstrap-' + themeName + '.min.css');
        }
...
function docReady() {
    ...
    $('#file_upload').uploadify({
        'swf': '{{ URL::asset("admin/misc/uploadify.swf") }}',
        'uploader': '{{ URL::asset("admin/misc/uploadify.php") }}'
